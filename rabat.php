...
<main>
    <div class="side-bar">
        ...
        <ul class="nav-links">
            ...
            <li class="nav-tab" data-view-name="verification">
                <a href="#">
    ...
    <div class="main-content w-100 p-5">
        ...
        <div class="load" data-view-active="false">
            <h1>Consulter touts les dm </h1>
        </div>
        <div class="settings" data-view-active="false">
            <h1>Gestion d'utilisateur</h1>
        </div>
        <div class="Gestion_DM" data-view-active="false">
            <h1>creer DM</h1>
            <h1>suivi DM</h1>
        </div>
        ...
        <div class="verification" data-view-active="false">
            <h1>Verify</h1>
        </div>
