...
<main>
    <div class="side-bar">
        ...
        <ul class="nav-links">
            <?php if ($usertype == "user"): ?>
                ...
                <li class="nav-tab" data-view-name="reception">
                    <a href="#">
                ...
                <li class="nav-tab" data-view-name="Gestion_outillage">
                    <a href="#">
            ...
            Gestion outillage
                ...
                <li class="nav-tab" data-view-name="valorisation">
                    <a href="#">
            ...
            <?php elseif ($usertype == "dmi"): ?>
                ...
                <li class="nav-tab" data-view-name="DM">
                    <a href="#">
    ...
    <div class="main-content w-100 p-5">
        ...
        <?php if ($usertype == "user"): ?>
            ...
            <div class="reception" data-view-active="false">
                <?php
                require('dm_reception.php');
        ...
        <?php elseif ($usertype == "dmi"): ?>
            <div class="DM" data-view-active="true">
                <?php
                require('dmi_dm.php');
        ...
        <?php elseif ($usertype == "magasinier"): ?>
            <div class="dm_magasin" data-view-active="true">
                <?php
                require('magasinier_dm.php');
        ...
        <script>
            // JavaScript code to handle tab click event
            document.addEventListener("DOMContentLoaded", function () {
                ...
                navTabs.forEach(function (tab) {
                    tab.addEventListener("click", function () {
                        const viewName = this.dataset.viewName;
                        contentDivs.forEach(function (div) {
                            const isActive = div.dataset.viewActive === "true";
                            if (div.classList.contains(viewName)) {
                                div.dataset.viewActive = "true";
                            } else if (isActive) {
                                div.dataset.viewActive = "false";
                            }
                        });
                    });
                });
